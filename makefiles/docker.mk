...
.PHONY: docker-build
docker-build: docker-build-llama docker-build-artifacts docker-prune ## Build Dockerfile-artifacts and Dockerfile-debian
...
docker-build-artifacts: args?=
docker-build-artifacts: ## Build Dockerfile-artifacts
	./scripts/build-docker-artifacts.sh $(args)
